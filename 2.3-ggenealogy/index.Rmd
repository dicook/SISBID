...
pathG <- getPath("Irène Gijbels", "Gerda Claeskens", 
                 statIG, statGeneal)
plotPath(pathG)
plotPathOnAll(pathG, statGeneal, statIG, binVector = 1:6, pathEdgeCol =
  "seagreen2", nodeSize = 1, pathNodeSize = 3)
```
...
```{r}
p + geom_net(label = TRUE, labelcolour="white", vjust=0.5, hjust=0.5, directed=TRUE, arrowgap=0.075, aes(size = Predominance)) + theme_net() +
