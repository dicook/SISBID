...
- Add a data directory to this folder, that contains the `TB_notifications_2019-07-01.csv` data.  This keeps your tutoiral self-contained.
...
Because this is an html document, interactive graphics can be incorporated. We'll add a section to use interactive plots to examine the temporaral trend in TB incidence. 
...
A `flexdashboard` is an Rmarkdown format shiny app. It adds more control over plot elements and is more focused on the data analysis than on a stody or instructional materials. 
...
This is the full web app, and it feels a little more like actually coding.
