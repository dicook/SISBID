...
```{r compute the linear trend in counts, echo=TRUE}
...
```{r one way to make the map is use geom_map, echo=TRUE}
...
```{r aother approach is to join the polygon data, echo=TRUE}
