...
---
# TB notifications (pivot_long)
  
create two new variables: variable `name` (contains all variable names starting with `new_sp_`) and variable `value` with the values:
