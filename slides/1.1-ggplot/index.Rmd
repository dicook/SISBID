...
<br>
.large[Write down as many types of data plots that you can think of.] 

Go to menti.com and enter code 2929 5844
...
Current tuberculosis data from [WHO](http://www.who.int/tb/country/data/download/en/), the case notifications table. Also can download with R package, [getTBinR](https://cran.r-project.org/web/packages/getTBinR/index.html).
