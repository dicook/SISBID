...
:::: columns
::: column
The basic plot plot for multivariate data is a scatterplot matrix. There are two functions available in the GGally package: `ggpairs`.
...
:::: columns
::: column
Only show correlation, using a corrgram. Again, this is dangerous, and only useful to get a broad overview of association that is suitably summarized by correlation.
