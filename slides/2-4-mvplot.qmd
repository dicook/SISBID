...
```{r p-heatmap, echo=TRUE, fig.show='hide'}
...
```{r ref.label="p-heatmap", eval=TRUE, echo=FALSE, fig.width=3, fig.height=7, out.width="50%"}
```
...
```{r hexbin scatterplot, fig.width=6, fig.height=6, echo =TRUE, eval=FALSE}
...
```{r generalised-pairs-plot, error=FALSE, message = FALSE, warning = FALSE, echo = TRUE, fig.width=6, fig.height=6}
#| output-location: "column"
...
::: column
```{r echo=FALSE, fig.width=6, fig.height=6, outwidth="90%"}
...
```{r wrangle-housing-data-and-make-a-regression-style-pairs-plot, out.width="80%", fig.width=8, fig.height=3}
