...
```{r hexbin scatterplot, fig.width=6, fig.height=6, echo =T}
#| output-location: "column"
...
```{r generalised pairs plot, fig.show='hide', error=F, message = F, warning = F, echo = T}
#| output-location: "column"
...
```{r organise data pcp, eval=T, echo=FALSE}
