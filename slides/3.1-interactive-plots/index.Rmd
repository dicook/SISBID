...
write_csv(cran_dls, file = "../../data/package-info-Jul-2024.csv")
```
...
plot_ly(data = penguins, x = ~flipper_length_mm, y = ~bill_depth_mm, color = ~species, size = 5)
```
...
```{r}
gg <- ggplot(data=penguins, aes(x = flipper_length_mm, y = bill_depth_mm, colour = species)) +  
...
library(GGally)
p <- ggpairs(penguins, columns = 3:6, 
