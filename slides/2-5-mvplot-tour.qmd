...
- The separation between clusters is larger and 
- there are a few more unusual penguins.
...
## Understanding a tour {.smaller}

<iframe width="1200" height="800" src="html/penguins.html" title="Animation of AFLW four PCs with interactive labelling."></iframe>
...
## Understanding the projections {.smaller}

::: columns
::: column
```{r runthis1, fig.width=4, fig.height=4, out.width="80%"}
ggplot(penguins_std, 
   aes(x=fl, y=bd,
       colour=species)) +
...
```{r runthis2, fig.width=4, fig.height=4, out.width="80%"}
ggplot(penguins_std, 
   aes(x=bl, y=bm,
       colour=species)) +
  geom_point(alpha=0.7, size=2) +
...
## Geometric shapes with slice tour {.smaller}
...
## Saving and sharing: single frame {.smaller}
