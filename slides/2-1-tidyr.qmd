...
- An explanation of the differences in the pipes can be found [here](https://towardsdatascience.com/understanding-the-native-r-pipe-98dea6d8b61b)
:::
::: column
![](images/pipe.gif)
:::
...
## {background-image="images/lego.png" background-size="100%" background-position= "50% 5%"}
...
**Selectors** can be used to identify variables by **name**, **position**, a range (using `:`), a pattern, or a combination of all.
