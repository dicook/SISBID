...
<<<<<<< HEAD:slides/_3-6-interactive-document.qmd
=======
...
>>>>>>> 4878b57bfe0f02cf286f5e601203113922ee28c5:slides/3.6-make_your_own_interactive_document/index.Rmd
---
...
A dashboard is a `quarto` format `shiny` app. It adds more control over plot elements and is more focused on the data analysis than on a study or instructional materials. 
=======
...
:::
::: column
Create a "New Quarto" document -> "Interactive"
