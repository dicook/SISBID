...
Scenario II (same data, different nulls):((1) pick pm from U[0,1]((for the kth lineup evaluation do:((2) pick m-1 values pi from U[0,1]((3) compute q = (1-pm)/∑j(1-pj)((4) get xk ~ B1,q(X = ∑k xk(Repeat (2)-(4) K times to get X((Repeat process N times to get distribution of X(
