...
.pull-right[
```{r explore tb mortality trends interactively, echo=TRUE, out.width="100%", fig.width=9, fig.height=8}
...
```{r plot the countries that have decreasing mortality trend, echo=TRUE, out.width="100%", fig.width=7, fig.height=4}
...
```{r explore tb mortality trends problem countries, echo=TRUE, out.width="100%", fig.width=7, fig.height=3}
